...
export { getActiveItems, getPrimaryItem, getFirstImage, getGalleryImages, getSizeParts, getProductTagIds, getMinPrice, hasMultiplePrices, formatItemLabel } from './model/dishDisplay'
