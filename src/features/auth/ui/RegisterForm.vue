...
const ok   = 'border-line bg-surface focus-visible:border-accent focus-visible:ring-accent/20'
const err  = 'border-red-400 bg-surface focus-visible:border-red-400 focus-visible:ring-red-200'
