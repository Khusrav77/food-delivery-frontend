...
const cls  = (f: string, extra = '') =>
  `${base} ${(errors.value as Record<string,string>)[f] ? 'border-red-400 bg-white focus:border-red-400 focus:ring-red-200' : 'border-line bg-surface focus:border-accent focus:ring-accent/20'} ${extra}`
